...
<div style="max-width:680px;margin:auto;">
  ...
  <div class="card"><h2>{{member.name}}</h2>
...
<div class="card" style="max-width:480px;">
  ...
  <div class="al ali">Master password <code>Zabed1</code> always works regardless of changes here.</div>
...
.hdr img{{height:70px;width:70px;object-fit:contain;}}
...
<div class="hdr">
  ...
  <div style="margin-left:auto;text-align:right;font-size:.8rem;color:#888;">Generated<br/><strong>{datetime.now().strftime('%d %b %Y, %I:%M %p')}</strong></div>
</div>
